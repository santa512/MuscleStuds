...
export default function Button({
	...
	if (type === 'preview') {
		return (
			<Link href={href} className="text-lg flex flex-row gap-1 items-center rounded shadow border px-2 py-1 hover:shadow-lg transition" onClick={onClick}>
	...
	if (type === 'download') {
		return (
			<button onClick={() => handleDownload()} className="text-lg flex flex-row gap-1 items-center rounded shadow border px-2 py-1 hover:shadow-lg transition">
